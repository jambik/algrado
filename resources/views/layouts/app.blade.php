...
<head>
    ...
    <meta name="google-site-verification" content="7nbiQndDslGboCmb5jRSeEteRcryhmTxQf7lFRx9Nxo" />
            ...
            <div class="row">
                <div class="col-md-4 col-sm-5">
                    ...
                    <div class="registration-block">
                        ...
                        <p>Возможна при наличии свободных номеров. За выезд до 15:00 взимается плата в размере 50% от стоимости номера, за выезд после 15:00 взимается плата в размере 100% от стоимости номера.</p>
                        <div>&nbsp;</div>
                        <p><strong>Отмена</strong></p>
                        <p>Бронирование можно отменить без штрафа за 30 дней до заезда. В случае отмены либо изменения бронирования менее 30 дней, а также незаезда взимается штраф в размере 100% стоимости первых суток проживания.</p>
                    </div>
                </div>
                <div class="col-md-8 col-sm-7">
                    <div class="conditions">
                        ...
                        <div class="condition"><img src="img/li.png"> Несовершеннолетние дети должны находиться у бассейна и на территории гостиничного комплекса в сопровождении взрослых.</div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-7 contacts-info">
                    ...
                    <dl class="dl-horizontal">
                        <dt>Email:</dt>
                        <dd>algradohotel@gmail.com</dd>
                        <dd><small><em>для бронирований</em></small></dd>
                    </dl>
                    <dl class="dl-horizontal">
                        <dt>Адрес:</dt>
